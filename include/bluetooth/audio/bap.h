...
/** @brief Broadcast sink init.
 * *
 *  Should be called before any broadcast sink apis.
 */
...
/**
 * @brief Init for the Basic Audio Profile Scan Delegator
 *
 * Should be called before any Basic Audio Profile Scan Delegator APIs.
 */
int bt_bap_scan_delegator_init(void);

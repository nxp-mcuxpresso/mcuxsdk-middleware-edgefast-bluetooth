...
#if (defined(CONFIG_BT_OTS_OACP_DELETE_SUPPORT) && (CONFIG_BT_OTS_OACP_DELETE_SUPPORT > 0))
...
#if (defined(CONFIG_BT_OTS_OACP_READ_SUPPORT) && (CONFIG_BT_OTS_OACP_READ_SUPPORT > 0))
...
#if (defined(CONFIG_BT_OTS_OLCP_GO_TO_SUPPORT) && (CONFIG_BT_OTS_OLCP_GO_TO_SUPPORT > 0))
...
#if (defined(CONFIG_BT_OTS_SECONDARY_SVC) && (CONFIG_BT_OTS_SECONDARY_SVC > 0))
